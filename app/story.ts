...
export const STORY_STAGES: StoryStage[] = [
  {
    ...
    x: 76,
    y: 53,
    crisis: "숫자 세균이 마닐라의 식량 창고와 구호 물자에 번지면서 보급품을 공평하게 나누지 못하고 있습니다. 대피소마다 식량 수량이 달라져 배급이 멈출 위기입니다.",
  ...
  },
  {
    ...
    x: 84,
    y: 76,
    crisis: "배수 규칙으로 증식하는 세균이 시드니 항만의 컨테이너와 전력 장치를 연속 감염시키고 있습니다. 증식 순서를 예측하지 못하면 항구 전체가 폐쇄됩니다.",
  ...
  },
  {
    ...
    x: 56,
    y: 62,
    crisis: "나이로비 구호 창고에 세균이 퍼져 사과와 귤 보급품을 같은 수의 봉지로 나누지 못하고 있습니다. 식량 배분이 늦어지며 여러 대피소가 보급 부족을 겪고 있습니다.",
  ...
  },
  {
    ...
    x: 53,
    y: 47,
    crisis: "카이로 병원에서 사용하는 치료 꽃의 영양액이 감염되었습니다. 장미와 튤립을 같은 수의 꽃병에 정확히 나누지 못하면 치료 물질 생산이 중단됩니다.",
  ...
  },
  {
    ...
    x: 51,
    y: 36,
    crisis: "로마의 정수 시설과 도시 농장에 물을 공급하는 장치들이 서로 다른 주기로 감염되고 있습니다. 급수 시점을 맞추지 못해 식물과 식수 저장고가 동시에 위험해졌습니다.",
  ...
  },
  {
    ...
    x: 46,
    y: 29,
    crisis: "감염 안개가 영국 해협을 뒤덮고 등대의 점등 장치를 교란하고 있습니다. 두 등대가 함께 켜지는 순간을 놓치면 구조선들이 항로를 찾지 못합니다.",
  ...
  },
  {
    ...
    x: 31,
    y: 70,
    crisis: "아마존 강의 정수 기지들이 약수와 배수로 이어진 감염망에 묶였습니다. 연결이 끊기지 않으면 강 주변 마을로 오염된 물이 계속 퍼지게 됩니다.",
  ...
  },
  {
    ...
    x: 24,
    y: 37,
    crisis: "뉴욕 철도 신호망에 세균이 퍼져 서로 다른 간격의 열차들이 같은 선로에 진입하고 있습니다. 도시 교통이 멈췄고 다음 동시 도착 시각에는 충돌 위험까지 있습니다.",
  ...
  },
  {
    ...
    x: 18,
    y: 19,
    crisis: "북극권의 마지막 지구 방어 기지가 복합 숫자 세균에게 포위되었습니다. 통신과 보급 항로가 차례로 끊기며 다른 대륙에 치료 신호를 보낼 수 없는 상황입니다.",
  ...
  },
  {
    ...
    x: 92,
    y: 58,
    crisis: "태평양 무인도의 원천균이 계속 숫자를 바꾸며 전 세계 감염망을 다시 활성화하고 있습니다. 지금 제거하지 못하면 이미 해방한 지역까지 모두 재감염됩니다.",
